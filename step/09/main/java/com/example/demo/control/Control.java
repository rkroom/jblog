...
public class Control {
    ...
    public ModelAndView page(@PathVariable("pagenum") int pagenum){
        ...
        page.addObject("index",pagingService.selectAllByPage(true,(pagenum-1)*10) );
        int pagenumber = pagingService.selectCountByStatus(true);
        page.addObject("paging",pagenumber);
        return page;
    }
